...
function validateForm() {
    ...
    ['name', 'email', 'phone', 'from', 'to', 'vehicle', 'date', 'participants'].forEach(clearError);
    ...
    if (phone === '') {
        ...
        showError('phone', 'Format nomor telepon tidak valid (contoh: 08123456789)');
        isValid = false;
    }
...
const destinationBookingBtns = document.querySelectorAll('.destination-overlay .btn');
...
console.log('%c🚌 PT Travel BangKi Nusantara 🚌', 'color: #d4af37; font-size: 20px; font-weight: bold;');
console.log('%cTransportasi Lintas Sumatra Terpercaya Sejak 2015', 'color: #1a2332; font-size: 14px;');
console.log('%cPerjalanan nyaman dan aman di seluruh Pulau Sumatra!', 'color: #2c3e50; font-size: 12px;');
